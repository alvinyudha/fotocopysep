                    ...
                    <tbody>
                        ...
                        <?php foreach ($cetakfoto as $c) : ?>
                            <tr>
                                ...
                                <td>
                                    <a href="" class="badge badge-success" id="tombolEdit" data-toggle="modal" data-target="#editCetakFoto<?= $c['id']; ?>"><i class="fa fa-edit"></i> edit</a>
                                    <a href="<?= base_url('cetakfoto/hapus/') . $c['id']; ?>" class="badge badge-danger" onclick="return confirm('yakin ingin menghapus?');"><i class="fa fa-trash"></i> delete</a>
                                </td>
                            </tr>
                        <?php endforeach; ?>
